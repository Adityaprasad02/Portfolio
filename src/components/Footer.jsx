    ...
    <footer style={{ borderTop: "1px solid rgba(59,130,246,0.1)", padding: "40px 28px", width: "100%" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: 20 }}>
        <div>
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 13, color: "#64748b", margin: "6px 0 0", fontWeight: 500 }}>© 2026 </p>
        </div>
        <div style={{ display: "flex", gap: 28 }}>
          {[{ icon: Github, label: "GitHub", href: "https://github.com/Adityaprasad02" }, { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/adityaps09/" }].map(({ icon: Icon, label, href }) => (
